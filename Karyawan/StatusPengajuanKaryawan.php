    ...
    <div id="content">
        <div class="container mt-3"> 
            ...
            <div class="custom-table-container">
                <table class="table table-bordered" style="background-color: rgba(220, 220, 220, 0.8); width: 100%;" id="dataTable" cellspacing="0">
                <thead>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class='text-center'>
                            ...
                            <td style="width: 10%;"><?php echo htmlspecialchars($row['NamaJenisAbsensi']); ?></td>
                            <td style="width: 17%;"><?php echo htmlspecialchars($row['TanggalPengajuan']); ?></td>
                            <td style="width: 17%;">
                                <?php
