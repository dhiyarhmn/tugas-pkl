            ...
            if ($currentPassword === $row["Password"]) {
                if ($newPassword === $confirmPassword) {
                    ...
                    if ($updateStatement->execute()) {
                        header("Location: EditProfileKaryawan.php");
                        exit();
                    } else {
    ...
    <div>
        <div class="container mt-3">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-md-6">
                <a href="EditProfileKaryawan.php" class="btn custom-detail-btn-blue" style="font-size: 12px; padding: 10px 10px; width: 120px; margin-top: 30px;">
