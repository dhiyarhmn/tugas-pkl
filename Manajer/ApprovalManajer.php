                            ...
                            echo "<tr>
                                    ...
                                    <td class='text-center'>
                                        ...
                                        <div style='text-align: center; margin-top: 10px;'>
                                            <button style='width: 100%;' type='button' class='btn custom-detail-btn-blue' data-toggle='modal' data-target='#detailModal' onclick='showDetail(". htmlspecialchars($row['AbsensiID']) .")'>Detail</button>
                                        </div>
                                    </td>
                                  </tr>";
                            $no++;
